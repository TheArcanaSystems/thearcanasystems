...
import { Send, Wand2, CalendarClock, Inbox, CheckCircle2 } from "lucide-react";
...
function buildCaption(hookId: string) {
  const hook = hooks.find((h) => h.id === hookId);
  if (!hook) return "";
  return `${hook.hookText} A closer look at the ${hook.angle} angle for ${hook.niche} creators. #contentstrategy`;
}
            ...
            <DialogContent className="sm:max-w-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      disabled={!hookId}
                      onClick={() => setCaption(buildCaption(hookId))}
                    >
                  ...
                  <Textarea
                    id="post-caption"
                    rows={4}
                    placeholder="Select a hook, then autogenerate a caption"
                    value={caption}
                ...
                <div className="space-y-1.5">
                  ...
                  <PlatformCheckboxRow selected={platforms} onChange={setPlatforms} />
                </div>
